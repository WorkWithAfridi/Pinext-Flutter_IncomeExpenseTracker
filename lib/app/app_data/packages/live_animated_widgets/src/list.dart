...
/// ```
class LiveListState extends State<LiveList> with TickerProviderStateMixin<LiveList> {
  ...
  static int _computeSemanticChildCount(int itemCount) => math.max(0, itemCount * 2 - 1);
}
